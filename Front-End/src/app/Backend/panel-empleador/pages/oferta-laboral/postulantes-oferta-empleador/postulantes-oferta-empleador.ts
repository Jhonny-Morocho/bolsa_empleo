  ...
  contrarFinalizarOfertaLaboral(){
    ...
    if(this.existeAlgunPostulanteChechado==true){
          Swal({
            ...
            if (result.value) {
              let cambiarEstadoOferta=false;
              let contrarPostulante=false;
